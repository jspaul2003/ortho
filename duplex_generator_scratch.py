...
#<MODIFIABLE> Working concentration of strands
conc = 1e-6 
...
#<MODIFIABLE> Hamming distance similarity threshold
threshold_SIM = 12 

#<MODIFIABLE> Standard operating temperature of DNA reaction
rxn_temp = 37 
...
if __name__ == "__main__":
    ...
    library, on_t, nu_mat = on_target_optimization(on_t, library, threshold_ON, reporting, nu_mat)
    print_library_size(library)

    print("STEP 5/9: OFF-Target Optimization\n")
    library, on_t, nu_mat = off_target_optimization(nu_mat, library, threshold_OFF, reporting, on_t)
    print_library_size(library)
